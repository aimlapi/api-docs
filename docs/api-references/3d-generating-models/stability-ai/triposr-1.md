...
{% openapi-operation spec="triposr-test-without-code-samles" path="/v1/images/generations" method="post" %}
[OpenAPI triposr-test-without-code-samles](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/3d-generating-models/Stability-AI/triposr-test-copy.json)
