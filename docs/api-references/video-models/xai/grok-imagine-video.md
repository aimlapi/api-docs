...
<a href="https://aimlapi.com/app/grok-imagine-video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="grok-imagine-video" path="/v2/video/generations" method="post" %}
[OpenAPI grok-imagine-video](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/video-models/xAI/grok-imagine-video.json)
...
{% code overflow="wrap" %}
```json5
Generation ID:   0m25kAkw71oR0OCotP9XE
...
Status: generating. Checking again in 15 seconds.
Processing complete:
 {'id': '0m25kAkw71oR0OCotP9XE', 'status': 'completed', 'video': {'url': 'https://cdn.aimlapi.com/xenops/xai-vidgen-bucket/xai-video-3e3a3eaf-b822-4243-84d9-83fcc7b446f2.mp4'}}
```
{% endcode %}
...
{% embed url="https://drive.google.com/file/d/1nYhordJEjABChVie7gFenLZVdk8bwd47/view?usp=drive_link" %}
