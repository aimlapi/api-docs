...
<a href="https://aimlapi.com/app/?model=google/veo-3.1-t2v-fast&#x26;mode=video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% code overflow="wrap" %}
```json5
Generation ID:   8e9c4413-14db-454e-b7c0-6e8cd6d25418:google/veo-3.1-t2v-fast
Status: generating
...
Status: completed
Processing complete:
{'id': '8e9c4413-14db-454e-b7c0-6e8cd6d25418:google/veo-3.1-t2v-fast', 'status': 'completed', 'video': {'url': 'https://cdn.aimlapi.com/flamingo/files/b/lion/b4MqgPJ6bc8pb--uNYD_M_output.mp4'}}
