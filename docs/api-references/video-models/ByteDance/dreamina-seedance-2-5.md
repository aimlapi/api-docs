...
<a href="https://aimlapi.com/app/bytedance/dreamina-seedance-2-5" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}

## Model Overview

Seedance 2.5 is a ByteDance video generation model with multi-reference conditioning and synchronized audio.
...
{% openapi-operation spec="dreamina-seedance-2-5" path="/v2/video/generations" method="post" %}
[OpenAPI dreamina-seedance-2-5](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/video-models/ByteDance/dreamina-seedance-2-5.json)
...
generation = requests.post(url, headers=headers, json={'model': 'bytedance/dreamina-seedance-2-5', 'prompt': 'Describe what you want the model to generate.', 'image_url': 'https://example.com/input.jpg', 'duration': '5'})
...
const generation = await fetch(url, {
  ...
  headers,
  body: JSON.stringify({
  "model": "bytedance/dreamina-seedance-2-5",
