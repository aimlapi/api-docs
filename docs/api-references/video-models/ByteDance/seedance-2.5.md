...
<a href="https://aimlapi.com/app/bytedance/seedance-2-5" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="seedance-2-5" path="/v2/video/generations" method="post" %}
[OpenAPI seedance-2-5](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/video-models/ByteDance/seedance-2.5.json)
...
generation = requests.post(url, headers=headers, json={'model': 'bytedance/seedance-2-5', 'prompt': 'Describe what you want the model to generate.', 'image_url': 'https://example.com/input.jpg', 'duration': '5'})
