...
<a href="https://aimlapi.com/app/alibaba/wan2-7-r2v" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="wan2-7-r2v" path="/v2/video/generations" method="post" %}
[OpenAPI wan2-7-r2v](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/video-models/Alibaba-Cloud/wan2.7-r2v.json)
...
{% code overflow="wrap" %}
```json5
{'id': 'B4s9SMzh12gKpK9EGuzez', 'status': 'queued', 'meta': {'usage': {'credits_used': 3900000, 'usd_spent': 1.95}}}
Generation ID:   B4s9SMzh12gKpK9EGuzez
...
Status: generating. Checking again in 15 seconds.
Processing complete:
 {'id': 'B4s9SMzh12gKpK9EGuzez', 'status': 'completed', 'video': {'url': 'https://cdn.aimlapi.com/generations/alligator/1778021564136-f9fa8fdc-17a9-4b89-91f7-27eacc440a87.mp4'}}
```
{% endcode %}
...
{% embed url="https://drive.google.com/file/d/1Wug19sPaXfgJYkool1tM7tr73069ozo8/view?usp=sharing" %}
