# Wan 2.2 14b animate replace (Image-to-Video)
...
{% column width="25%" %}
<a href="https://aimlapi.com/app/?model=alibaba/wan2.2-14b-animate-replace&#x26;mode=video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
