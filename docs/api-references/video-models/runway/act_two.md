...
<a href="https://aimlapi.com/app/runway/act_two" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="runway-act-two" path="/v2/video/generations" method="post" %}
