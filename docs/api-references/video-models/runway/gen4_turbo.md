...
<a href="https://aimlapi.com/app/runway/gen4_turbo" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="runway-gen4-turbo" path="/v2/video/generations" method="post" %}
