...
<a href="https://aimlapi.com/app/kling-video/v1-6/standard/text-to-video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% code overflow="wrap" %}
```json5
Generation ID:   vn9XMO80UyV9BSq6K6G_O
...
Processing complete: {'id': 'vn9XMO80UyV9BSq6K6G_O', 'status': 'completed', 'video': {'url': 'https://cdn.aimlapi.com/flamingo/files/b/0a8b2511/HG_-uFLYZfjQJwW8bS3oF_output.mp4'}}
```
{% endcode %}
...
{% embed url="https://drive.google.com/file/d/1P1YEvTMt9DkPaYtFKDL6LH0d1J0CVFwJ/view" %}
