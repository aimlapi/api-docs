...
{% openapi src="../../../.gitbook/assets/v1.6-pro-image-to-video-pair.json" path="/v2/generate/video/kling/generation" method="get" %}
[v1.6-pro-image-to-video-pair.json](../../../.gitbook/assets/v1.6-pro-image-to-video-pair.json)
{% endopenapi %}
