# Kling 3.0 Omni 720p Image to Video
...
<a href="https://aimlapi.com/app/klingai/video-v3-omni-720p-image-to-video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}

## Model Overview

Kling 3.0 Omni image-to-video animates images into 720p videos with optional native audio.
...
{% openapi-operation spec="v3-omni-720p-image-to-video" path="/v2/video/generations" method="post" %}
[OpenAPI v3-omni-720p-image-to-video](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/video-models/Kling-AI/v3-omni-720p-image-to-video.json)
...
generation = requests.post(url, headers=headers, json={'model': 'klingai/video-v3-omni-720p-image-to-video', 'prompt': 'Describe what you want the model to generate.', 'image_url': 'https://example.com/input.jpg', 'duration': '5'})
...
const generation = await fetch(url, {
  ...
  headers,
  body: JSON.stringify({
  "model": "klingai/video-v3-omni-720p-image-to-video",
