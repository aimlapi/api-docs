# Kling 3.0 Omni 1080p Text to Video
...
<a href="https://aimlapi.com/app/klingai/video-v3-omni-1080p-text-to-video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}

## Model Overview

Kling 3.0 Omni text-to-video generates 1080p videos from text prompts with optional native audio.
...
{% openapi-operation spec="v3-omni-1080p-text-to-video" path="/v2/video/generations" method="post" %}
[OpenAPI v3-omni-1080p-text-to-video](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/video-models/Kling-AI/v3-omni-1080p-text-to-video.json)
...
generation = requests.post(url, headers=headers, json={'model': 'klingai/video-v3-omni-1080p-text-to-video', 'prompt': 'Describe what you want the model to generate.', 'duration': '5'})
...
const generation = await fetch(url, {
  ...
  headers,
  body: JSON.stringify({
  "model": "klingai/video-v3-omni-1080p-text-to-video",
