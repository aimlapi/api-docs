...
# Submit a request
## API Schema
{% swagger src="./v1.6-standart-image-to-video.json" path="/v2/generate/video/kling/generation" method="post" %}
./v1.6-standart-image-to-video.json
{% endswagger %}

{% swagger src="./v1.6-standart-image-to-video-pair.json" path="/v2/generate/video/kling/generation" method="get" %}
./v1.6-standart-image-to-video-pair.json
{% endswagger %}
