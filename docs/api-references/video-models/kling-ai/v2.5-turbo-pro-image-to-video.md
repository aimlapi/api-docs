...
<a href="https://aimlapi.com/app/klingai/v2-5-turbo/pro/image-to-video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="klingai-v2-5-turbo-pro-image-to-video" path="/v2/video/generations" method="post" %}
