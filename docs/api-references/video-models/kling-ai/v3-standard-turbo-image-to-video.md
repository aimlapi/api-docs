...
<a href="https://aimlapi.com/app/v3-standard-turbo-image-to-video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="video-v3-standard-turbo-image-to-video" path="/v2/video/generations" method="post" %}
[OpenAPI video-v3-standard-turbo-image-to-video](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/video-models/Kling-AI/v3-standard-turbo-image-to-video.json)
...
def generate_video():
    ...
    data = {
        "model": "klingai/video-v3-standard-turbo-image-to-video",
...
function generateVideo(callback) {
  const data = JSON.stringify({"model": "klingai/video-v3-standard-turbo-image-to-video", "prompt": "Mona Lisa puts on glasses with her hands.", "image_url": "https://raw.githubusercontent.com/aimlapi/api-docs/main/reference-files/mona_lisa_extended.jpg"});
