...
<a href="https://aimlapi.com/app/kling-video/v1-6/pro/text-to-video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="v1-6-pro-text-to-video" path="/v2/video/generations" method="post" %}
[OpenAPI v1-6-pro-text-to-video](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/video-models/Kling-AI/v1.6-pro-text-to-video.json)
...
{% code overflow="wrap" %}
```json5
Generation ID:   zieO13nuA445by0d1Ozvq
...
{% embed url="https://drive.google.com/file/d/1QR6IDOYJayyFFh_N05ZEozZcRgNvmn9V/view?usp=sharing" %}
