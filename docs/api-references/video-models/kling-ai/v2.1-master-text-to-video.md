...
<a href="https://aimlapi.com/app/klingai/v2-1-master-text-to-video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="klingai-v2-1-master-text-to-video" path="/v2/video/generations" method="post" %}
