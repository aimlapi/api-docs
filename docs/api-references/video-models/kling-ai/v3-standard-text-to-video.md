...
<a href="https://aimlapi.com/app/klingai/video-v3-standard-text-to-video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}

Text-to-video generation with cinematic visuals, smooth motion, built-in audio generation, and support for multi-shot scenes.
...
{% openapi-operation spec="video-v3-standard-text-to-video" path="/v2/video/generations" method="post" %}
[OpenAPI video-v3-standard-text-to-video](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/video-models/Kling-AI/video-v3-standard-text-to-video.json)
...
{% code overflow="wrap" %}
```json5
Generation ID:   m4WgO9-aUFTyIJpDb8exl
...
Status: generating. Checking again in 15 seconds.
Processing complete:
 {'id': 'm4WgO9-aUFTyIJpDb8exl', 'status': 'completed', 'video': {'url': 'https://cdn.aimlapi.com/flamingo/files/b/0a8d688e/iMvhPnFDL8pMtF3_Nd567_output.mp4'}}
```
{% endcode %}

</details>

**Processing time**: \~ 7 min 11 sec.

**Generated video** (1280x720, with sound):

{% embed url="https://drive.google.com/file/d/1RX5shfG2ysAG4zQzXypstDoqBA9eGU7W/view?usp=sharing" %}
