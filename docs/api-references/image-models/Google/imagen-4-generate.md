...
<a href="https://aimlapi.com/app/imagen4/preview" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="imagen-4-generate" path="/v1/images/generations" method="post" %}
[OpenAPI imagen-4-generate](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/image-models/Google/imagen-4-generate.json)
...
response = requests.post(
    ...
    json={'model': 'imagen4/preview', 'prompt': 'Describe what you want the model to generate.'},
)
