...
<a href="https://aimlapi.com/app/google/gemini-3-pro-image-edit" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
response = requests.post(
    ...
    json={'model': 'google/gemini-3-pro-image-edit', 'prompt': 'Describe what you want the model to generate.'},
)
