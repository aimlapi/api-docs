...
<a href="https://aimlapi.com/app/bytedance/seedream-5-0-pro" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="seedream-5-0-pro" path="/v1/images/generations" method="post" %}
[OpenAPI seedream-5-0-pro](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/image-models/ByteDance/seedream-5-0-pro.json)
...
response = requests.post(
    ...
    json={'model': 'bytedance/seedream-5-0-pro', 'prompt': 'Describe what you want the model to generate.'},
)
