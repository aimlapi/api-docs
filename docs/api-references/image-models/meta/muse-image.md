...
<a href="https://aimlapi.com/app/meta/muse-image" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="muse-image" path="/v1/images/generations" method="post" %}
[OpenAPI muse-image](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/image-models/meta/muse-image.json)
...
response = requests.post(
    ...
    json={'model': 'meta/muse-image', 'prompt': 'Describe what you want the model to generate.'},
)
