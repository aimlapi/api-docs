...
<a href="https://aimlapi.com/app/blackforestlabs/flux-2-lora-edit" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="flux-2-lora-edit" path="/v1/images/generations" method="post" %}
[OpenAPI flux-2-lora-edit](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/image-models/flux/flux-2-lora-edit.json)
