...
<a href="https://aimlapi.com/app/o1" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
Only `model` and `messages` are required parameters for this model (and we’ve already filled them in for you in the example), but you can include optional parameters if needed to adjust the model’s behavior. Below, you can find the corresponding [API schema](o1.md#api-schemas), which lists all available parameters along with notes on how to use them.
...
{% openapi-operation spec="o1-RESPONSES" path="/v1/responses" method="post" %}
[OpenAPI o1-RESPONSES](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/OpenAI/o1-RESPONSES.json)
{% endopenapi-operation %}
