...
{% hint style="warning" %}
**Deprecation notice**\
`chatgpt-4o-latest` was removed from the API on **February 17, 2026**. \
Please migrate to [`gpt-5.1-chat-latest`](../openai/gpt-5-1-chat-latest.md).
{% endhint %}
...
<a href="https://aimlapi.com/app/openai/gpt-4o" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
At the bottom of this page, you'll find [a code example](gpt-4o.md#code-example) that shows how to structure the request. Choose the code snippet in your preferred programming language and copy it into your development environment.
