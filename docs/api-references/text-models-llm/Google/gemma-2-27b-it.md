...
<a href="https://aimlapi.com/app/google/gemma-2-27b-it" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}

## Model Overview

Gemma 2 27B is available through the AI/ML API.
...
response = requests.post(
    ...
    json={'model': 'google/gemma-2-27b-it', 'messages': ['<message>']},
)
