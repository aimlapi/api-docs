...
<a href="https://aimlapi.com/app/x-ai/grok-4-3" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="grok-4-3" path="/v1/chat/completions" method="post" %}
[OpenAPI grok-4-3](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/xai/grok-4-3.json)
{% endopenapi-operation %}

{% openapi-operation spec="grok-4-3-RESPONSES" path="/v1/responses" method="post" %}
[OpenAPI grok-4-3-RESPONSES](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/xai/grok-4-3-RESPONSES.json)
{% endopenapi-operation %}
...
response = requests.post(
    ...
    json={'model': 'x-ai/grok-4-3', 'messages': ['<message>']},
)
