...
August 2025 update of the [DeepSeek V3](../DeepSeek/deepseek-chat.md) non-reasoning model.
...
[OpenAPI deepseek-chat-v3-1](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/DeepSeek/deepseek-chat-v3.1.json)
