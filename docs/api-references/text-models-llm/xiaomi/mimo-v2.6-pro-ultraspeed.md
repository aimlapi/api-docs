...
MiMo-V2.6-Pro-UltraSpeed — the fast-speed edition of Xiaomi's flagship MiMo-V2.6-Pro. Built from the same 1T MiMo-V2.6-Pro checkpoint, it matches the original model in quality while delivering roughly 10x faster inference, with a 1M token context window and text, image, video and audio understanding.
...
{% openapi-operation spec="mimo-v2-6-pro-ultraspeed" path="/v1/chat/completions" method="post" %}
[OpenAPI mimo-v2-6-pro-ultraspeed](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/xiaomi/mimo-v2.6-pro-ultraspeed.json)
