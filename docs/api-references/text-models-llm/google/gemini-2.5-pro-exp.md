...
At the bottom of this page, you'll find [a code example](gemini-2.5-pro-exp.md#code-example) that shows how to structure the request. Choose the code snippet in your preferred programming language and copy it into your development environment.
...
{% openapi-operation spec="gemini-2-5-pro-exp" path="/v1/chat/completions" method="post" %}
