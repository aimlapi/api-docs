...
<a href="https://aimlapi.com/app/meta/muse-glimmer-30b" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}

## Model Overview

Muse Glimmer 30B is available through the AI/ML API.
...
{% openapi-operation spec="muse-glimmer-30b" path="/v1/chat/completions" method="post" %}
[OpenAPI muse-glimmer-30b](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/meta/muse-glimmer-30b.json)
...
response = requests.post(
    ...
    json={'model': 'meta/muse-glimmer-30b', 'messages': ['<message>']},
)
