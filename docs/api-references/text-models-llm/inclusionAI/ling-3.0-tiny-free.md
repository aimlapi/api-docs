...
<a href="https://aimlapi.com/app/inclusionai/ling-3.0-tiny" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}

## Model Overview

Ling-3.0-tiny is available through the AI/ML API.
...
{% openapi-operation spec="ling-3-0-tiny-free" path="/v1/chat/completions" method="post" %}
[OpenAPI ling-3-0-tiny-free](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/inclusionAI/ling-3.0-tiny-free.json)
...
response = requests.post(
    ...
    json={'model': 'inclusionai/ling-3.0-tiny', 'messages': ['<message>']},
)
