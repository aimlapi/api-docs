...
<a href="https://aimlapi.com/app/inclusionai/ling-3.0-flash" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="ling-3-0-flash-free" path="/v1/chat/completions" method="post" %}
[OpenAPI ling-3-0-flash-free](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/inclusionAI/ling-3.0-flash-free.json)
...
response = requests.post(
    ...
    json={'model': 'inclusionai/ling-3.0-flash', 'messages': ['<message>']},
)
