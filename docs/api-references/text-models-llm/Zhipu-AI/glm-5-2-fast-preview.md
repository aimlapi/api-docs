...
* `zhipu/glm-5-2-fast-preview-fast-preview`
{% endhint %}
{% endcolumn %}

{% column width="33.33333333333334%" %}
<a href="https://aimlapi.com/app/zhipu/glm-5-2-fast-preview-fast-preview" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
response = requests.post(
    ...
    json={'model': 'zhipu/glm-5-2-fast-preview-fast-preview', 'messages': ['<message>']},
)
...
const response = await fetch('https://api.aimlapi.com/v1/chat/completions', {
  ...
  body: JSON.stringify({
  "model": "zhipu/glm-5-2-fast-preview",
  "messages": [
    "<message>"
  ]
}),
