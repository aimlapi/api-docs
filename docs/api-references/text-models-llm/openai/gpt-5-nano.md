...
<a href="https://aimlapi.com/app/openai/gpt-5-nano-2025-08-07" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
Only `model` and `messages` are required parameters for this model (and we’ve already filled them in for you in the example), but you can include optional parameters if needed to adjust the model’s behavior. Below, you can find the corresponding [API schema](gpt-5-nano.md#api-schemas), which lists all available parameters along with notes on how to use them.
...
{% openapi-operation spec="gpt-5-nano-RESPONSES" path="/v1/responses" method="post" %}
[OpenAPI gpt-5-nano-RESPONSES](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/OpenAI/gpt-5-nano-RESPONSES.json)
{% endopenapi-operation %}
