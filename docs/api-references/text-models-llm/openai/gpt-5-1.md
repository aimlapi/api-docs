...
<a href="https://aimlapi.com/app/openai/gpt-5-1" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
Only `model` and `messages` are required parameters for this model (and we’ve already filled them in for you in the example), but you can include optional parameters if needed to adjust the model’s behavior. Below, you can find the corresponding [API schema](gpt-5-1.md#api-schemas), which lists all available parameters along with notes on how to use them.
