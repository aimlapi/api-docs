...
NVIDIA Nemotron 3.5 Content Safety is a multimodal guard model from the Nemotron 3.5 family that classifies text and image content against safety policies, intended for moderating prompts and model responses rather than open-ended generation.
...
{% openapi-operation spec="nemotron-3-5-content-safety" path="/v1/chat/completions" method="post" %}
[OpenAPI nemotron-3-5-content-safety](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/nvidia/nemotron-3.5-content-safety.json)
