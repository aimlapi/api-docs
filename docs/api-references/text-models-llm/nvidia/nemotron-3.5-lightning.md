...
<a href="https://aimlapi.com/app/nvidia/nemotron-3.5-lightning" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
{% openapi-operation spec="nemotron-3-5-lightning" path="/v1/chat/completions" method="post" %}
[OpenAPI nemotron-3-5-lightning](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/nvidia/nemotron-3.5-lightning.json)
...
response = requests.post(
    ...
    json={'model': 'nvidia/nemotron-3.5-lightning', 'messages': ['<message>']},
)
