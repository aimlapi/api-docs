...
<a href="https://aimlapi.com/app/tencent/hy-mt2-30b-a3b" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}
...
It is the most capable of the three — [Hy-MT2-7B](hy-mt2-7b.md) and [Hy-MT2-1.8B](hy-mt2-1.8b.md) trade quality for latency and cost. Context window is 8192 tokens, with up to 4096 tokens of output.
...
{% openapi-operation spec="hy-mt2-30b-a3b" path="/v1/chat/completions" method="post" %}
[OpenAPI hy-mt2-30b-a3b](https://raw.githubusercontent.com/aimlapi/api-docs/refs/heads/main/docs/api-references/text-models-llm/tencent/hy-mt2-30b-a3b.json)
...
```json
{
  "id": "gen-1787591213-Bmwb26M2KpFId7JWIu89",
  ...
  "choices": [
    {
      ...
      "message": {
        "role": "assistant",
        "content": "La bibliothèque ferme à six heures en semaine.",
        "refusal": null,
        "reasoning": null
      }
    }
