...
{% hint style="info" %}
In the examples below for cURL, JavaScript and Python, we use the [**REST API**](../supported-sdks/#rest-api). This approach works with all of our APIs, but it is not the only way to integrate. You can use [**other supported SDKs**](../supported-sdks/).
{% endhint %}
...
* [Move to production-ready models: see the guide for connecting GPT-4o](requesting-more-advanced-models/)
