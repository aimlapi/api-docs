...
{% hint style="info" %}
Using the Cline CLI? `npx @aimlapi/cli cline` signs you in through the browser and sets AI/ML API as Cline's OpenAI Compatible provider for you. The Cline VS Code extension shares that setting too. See [CLI](../quickstart/cli.md#cline).
{% endhint %}
