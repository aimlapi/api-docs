...
{% hint style="info" %}
Prefer one command? `npx @aimlapi/cli claude` signs you in through the browser and starts Claude Code already connected to AI/ML API, with no key to copy or variables to export. See [CLI](../quickstart/cli.md#claude-code).
{% endhint %}
