...
<div align="left" data-with-frame="true"><figure><img src="../.gitbook/assets/image (1) (2) (1).png" alt="Running Aider with AI/ML API model"><figcaption><p>Running Aider with AI/ML API model</p></figcaption></figure></div>
