export default {
  ...
  messages: {
    ...
    user: {
      ...
      content: {
        ...
        file: {
          file_data: {
            desc: `The base64 encoded file data, used when passing the file to the model as a string.`,
          },
          file_id: {
            desc: `The ID of an uploaded file to use as input.`,
          },
          file_name: {
            desc: `The name of the file, used when passing the file to the model as a string.`,
          },
        },
      },
      role: {
  ...
  temperature: {
    ...
    anthropic: {
      desc: `Amount of randomness injected into the response.
  ...
  thinking: {
    desc: `Configuration for enabling Claude's extended thinking.
  
  When enabled, responses include thinking content blocks showing Claude's thinking process before the final answer. Requires a minimum budget of 1,024 tokens and counts towards your max_tokens limit.`,
    budget_tokens: {
      desc: `Determines how many tokens Claude can use for its internal reasoning process. Larger budgets can enable more thorough analysis for complex problems, improving response quality.
  ...
  min_p: {
    desc: `A number between 0 and 1 that can be used as an alternative to top_p and top-k.`,
  },
  top_a: {
