export default {
  ...
  image_url: {
    default: {
      desc: `The URL of the image to generate an image from.`,
    },
    triposr: {
      desc: `Path for the image file to be processed.`,
    },
  },
  ...
  colors: { desc: `An array of preferable colors.` },
  convert_base64_to_url: {
    desc: `If the condition is true, the url to the image will be returned; otherwise, the file will be provided in base64 format.`,
  },
  enhance_prompt: {
    desc: `An optional parameter to use an LLM-based prompt rewriting feature to deliver higher quality images that better reflect the original prompt's intent. Disabling this feature may impact image quality and prompt adherence.`,
  },
  person_generation: { desc: `Allow generation of people by the model.` },
